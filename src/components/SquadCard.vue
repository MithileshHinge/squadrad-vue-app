<template>
	<b-card class="sq-card p-2">
		...
		<b-button v-else :ref="'sqRefJoinBtn'+squad.squadId" class="sq-card-btn sq-btn-cta sq-btn my-1" :style="`background-image: linear-gradient(22deg, ${getJoinBtnGradientStops[squadNo]}, ${getJoinBtnGradientStops[squadNo + 1]}, ${getJoinBtnGradientStops[squadNo]});`">Join squad at <span class="sq-rupee"/>{{ squad.amount }}/month</b-button>
	</b-card>
</template>
